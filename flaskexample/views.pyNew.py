...
def myElevationfig(mtbMAPdf,prediction):
    ...
    #allDista = np.append(allDista, mtbMAPdf.distance[indRoute][-1])
    #allDista = np.insert(allDista,0,mtbMAPdf.distance[indRoute][0])
    
    allElevation = mtbMAPdf.altitude[indRoute]
    #allElevation = np.append(allElevation,0)
    #allElevation = np.insert(allElevation,0,0)
